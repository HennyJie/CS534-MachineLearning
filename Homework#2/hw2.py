...
@LastEditTime: 2019-10-06 13:12:18
'''
import datetime
import numpy as np
...
logistic = LogisticRegression(
    penalty="none", solver='newton-cg', fit_intercept=True).fit(X, y)
print("LogisticRegression coef: ", logistic.coef_)
print("LogisticRegression intercept: ", logistic.intercept_)
...
#         # l1_ratio = [0.00001, 0.001, 0.001, 0.01, 0.05, 0.1, 0.5, 0.7, 0.9, 0.95, 0.99, 1]
...
# y_pred = predictor.predict(predictor.test_X, regr)
